...
export default function ListCours(props) {
  ...
  return (
    <ul className="hs full">
      {data && data.filter(parcours => parcours.data.tags.toUpperCase().includes(searchField.toUpperCase()))
       
        .map((info, index) => (
          
          <li className="item" key={`${index + 1}n`}><Rating readOnly value={info.data.rating} />
